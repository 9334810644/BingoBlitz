    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md">
        <motion.div
          ...
          className="glass-panel border border-white/80 rounded-3xl p-7 sm:p-9 max-w-md w-full shadow-2xl text-slate-800 text-center relative overflow-hidden z-10"
        >
          ...
          <div className="bg-slate-50/90 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/80 mb-6 text-left space-y-2 shadow-inner">
            <div className="text-[10px] uppercase tracking-wider font-extrabold text-slate-500 flex items-center gap-1.5 mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={onClose}
              className="flex items-center justify-center gap-2 bg-slate-100/90 hover:bg-slate-200/80 text-slate-800 font-extrabold py-3.5 px-4 rounded-2xl border border-slate-200/80 transition-all active:scale-95 text-sm cursor-pointer shadow-xs"
            >
